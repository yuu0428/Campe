...
assert.equal(element('paceStatus').textContent,'累計+10秒');
...
assert.equal(element('paceStatus').textContent,'累計+15秒');
...
assert.equal(element('paceStatus').textContent,'累計−3秒');
...
assert.equal(element('paceStatus').textContent,'累計±0秒');
assert.equal(element('pageTiming').textContent,'頁+10秒');
vm.runInContext('elapsed=88000;updateTimer()',context);
assert.equal(element('paceStatus').textContent,'累計+5秒');
